...
VSE_Updatable *VSE_CreateUpdatable(
    void *data, void (*Update)(void *self, VSE_Engine *engine, float deltaTime))
{
...
void VSE_AddDefaultUpdatables(VSE_Engine *engine)
{
    ...
    VSE_AddUpdatable(engine, VSE_CreateComponentsUpdatable());
    VSE_AddUpdatable(engine, VSE_CreateDLLObserverUpdatable());
}
